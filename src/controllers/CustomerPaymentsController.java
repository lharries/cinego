...
public class CustomerPaymentsController implements Initializable {
    ...
    private void showSuccessModal() {
        ...
        alert.setContentText("Thank you for booking!\n" +
                "Your credit card has been charged with our secure API powered by stripe!\n" +
    ...
    private String confirmEmail() {
        ...
        dialog.setHeaderText("Booking Success!");
        dialog.setContentText("Booking success! Please confirm the email to which we will send your tickets:");
    ...
    /**
     * Buy the ticket but without using the stripe Api for payments
     *
     * @param actionEvent actionEvent
     */
    public void skipPayBtnHandler(ActionEvent actionEvent) {
        createBooking();
        ...
        try {
            ...
            LOGGER.logp(Level.WARNING, "CustomerPaymentsController", "skipPayBtnHandler", "Unable to send email" + e);
            e.printStackTrace();
        }
        ...
        try {
            ...
            LOGGER.logp(Level.WARNING, "CustomerPaymentsController", "skipPayBtnHandler", "Unable to switch views" + e);
            e.printStackTrace();
        }
